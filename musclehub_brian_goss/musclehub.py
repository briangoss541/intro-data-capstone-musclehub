...
member_counts = just_apps.groupby(['is_member', 'ab_test_group']).email.count().reset_index()
...
final_member_counts = df.groupby(['is_member', 'ab_test_group']).email.count().reset_index()
